...
For instance, by purely looking at the file data I/O numbers,
the engineering dataset had only 5\% of the in-use disk capacity touched
in the three-month period.
This figure doesn't account for files that were accessed multiple times.
This suggests that
